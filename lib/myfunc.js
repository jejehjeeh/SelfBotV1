...
exports.serialize = (xdev, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === xdev.user.jid ? true : false
    ...
    const conts = msg.key.fromMe ? xdev.user.jid : xdev.contacts[msg.sender]
	msg.pushname = msg.key.fromMe ? xdev.user.name : !conts ? '-' : conts.notify || conts.vname || conts.name || '-'   
